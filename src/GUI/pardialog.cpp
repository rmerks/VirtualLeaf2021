...
// add the first four widgets with (row, column) addressing
  ...
  grid->addWidget( new QLabel( "b4", this ),4, 8 );
  grid->addWidget( b4_edit, 4, 9 );
  grid->addWidget( new QLabel( "dir1", this ),5, 8 );
  grid->addWidget( dir1_edit, 5, 9 );
  grid->addWidget( new QLabel( "dir2", this ),6, 8 );
  grid->addWidget( dir2_edit, 6, 9 );
