...
ParameterDialog::ParameterDialog(QWidget *parent, Qt::WindowFlags f) : QDialog(parent,f) {
  ...
  compatibility_level_edit = new QLineEdit( QString("%1").arg(par.compatibility_level), this );
  elastic_modulus_edit = new QLineEdit( QString("%1").arg(par.elastic_modulus), this );
  ...
  k_edit = new QLineEdit( k_string, this );
...
// add the first four widgets with (row, column) addressing
  ...
  grid->addWidget( new QLabel( " <b>Cell mechanics</b>", this), 20, 0, 1, 2 );
  grid->addWidget( new QLabel( "compatibility_level", this ),21, 0 );
  grid->addWidget( compatibility_level_edit, 21, 1 );
  grid->addWidget( new QLabel( "elastic_modulus", this ),22, 0 );
  grid->addWidget( elastic_modulus_edit, 22, 1 );
  grid->addWidget( new QLabel( "T", this ),23, 0 );
  grid->addWidget( T_edit, 23, 1 );
  grid->addWidget( new QLabel( "lambda_length", this ),24, 0 );
  grid->addWidget( lambda_length_edit, 24, 1 );
  grid->addWidget( new QLabel( "yielding_threshold", this ),25, 0 );
  grid->addWidget( yielding_threshold_edit, 25, 1 );
  grid->addWidget( new QLabel( "lambda_celllength", this ),3, 2 );
  grid->addWidget( lambda_celllength_edit, 3, 3 );
  grid->setColumnMinimumWidth(3, 80);
  grid->addWidget( new QLabel( "target_length", this ),4, 2 );
  grid->addWidget( target_length_edit, 4, 3 );
  grid->addWidget( new QLabel( "cell_expansion_rate", this ),5, 2 );
  grid->addWidget( cell_expansion_rate_edit, 5, 3 );
  grid->addWidget( new QLabel( "cell_div_expansion_rate", this ),6, 2 );
  grid->addWidget( cell_div_expansion_rate_edit, 6, 3 );
  grid->addWidget( new QLabel( "auxin_dependent_growth", this ),7, 2 );
  grid->addWidget( auxin_dependent_growth_edit, 7, 3 );
  grid->addWidget( new QLabel( "ode_accuracy", this ),8, 2 );
  grid->addWidget( ode_accuracy_edit, 8, 3 );
  grid->addWidget( new QLabel( "mc_stepsize", this ),9, 2 );
  grid->addWidget( mc_stepsize_edit, 9, 3 );
  grid->addWidget( new QLabel( "mc_cell_stepsize", this ),10, 2 );
  grid->addWidget( mc_cell_stepsize_edit, 10, 3 );
  grid->addWidget( new QLabel( "energy_threshold", this ),11, 2 );
  grid->addWidget( energy_threshold_edit, 11, 3 );
  grid->addWidget( new QLabel( "bend_lambda", this ),12, 2 );
  grid->addWidget( bend_lambda_edit, 12, 3 );
  grid->addWidget( new QLabel( "alignment_lambda", this ),13, 2 );
  grid->addWidget( alignment_lambda_edit, 13, 3 );
  grid->addWidget( new QLabel( "rel_cell_div_threshold", this ),14, 2 );
  grid->addWidget( rel_cell_div_threshold_edit, 14, 3 );
  grid->addWidget( new QLabel( "rel_perimeter_stiffness", this ),15, 2 );
  grid->addWidget( rel_perimeter_stiffness_edit, 15, 3 );
  grid->addWidget( new QLabel( "collapse_node_threshold", this ),16, 2 );
  grid->addWidget( collapse_node_threshold_edit, 16, 3 );
  grid->addWidget( new QLabel( "morphogen_div_threshold", this ),17, 2 );
  grid->addWidget( morphogen_div_threshold_edit, 17, 3 );
  grid->addWidget( new QLabel( "morphogen_expansion_threshold", this ),18, 2 );
  grid->addWidget( morphogen_expansion_threshold_edit, 18, 3 );
  ...
  grid->addWidget( source_edit, 22, 3 );
  grid->addWidget( new QLabel( "D", this ),23, 2 );
  grid->addWidget( D_edit, 23, 3 );
  grid->addWidget( new QLabel( "initval", this ),24, 2 );
  grid->addWidget( initval_edit, 24, 3 );
  grid->addWidget( new QLabel( "k1", this ),3, 4 );
  grid->addWidget( k1_edit, 3, 5 );
  grid->setColumnMinimumWidth(5, 80);
  grid->addWidget( new QLabel( "k2", this ),4, 4 );
  grid->addWidget( k2_edit, 4, 5 );
  grid->addWidget( new QLabel( "r", this ),5, 4 );
  grid->addWidget( r_edit, 5, 5 );
  grid->addWidget( new QLabel( "kr", this ),6, 4 );
  grid->addWidget( kr_edit, 6, 5 );
  grid->addWidget( new QLabel( "km", this ),7, 4 );
  grid->addWidget( km_edit, 7, 5 );
  grid->addWidget( new QLabel( "Pi_tot", this ),8, 4 );
  grid->addWidget( Pi_tot_edit, 8, 5 );
  grid->addWidget( new QLabel( "transport", this ),9, 4 );
  grid->addWidget( transport_edit, 9, 5 );
  grid->addWidget( new QLabel( "ka", this ),10, 4 );
  grid->addWidget( ka_edit, 10, 5 );
  grid->addWidget( new QLabel( "pin_prod", this ),11, 4 );
  grid->addWidget( pin_prod_edit, 11, 5 );
  grid->addWidget( new QLabel( "pin_prod_in_epidermis", this ),12, 4 );
  grid->addWidget( pin_prod_in_epidermis_edit, 12, 5 );
  grid->addWidget( new QLabel( "pin_breakdown", this ),13, 4 );
  grid->addWidget( pin_breakdown_edit, 13, 5 );
  grid->addWidget( new QLabel( "pin_breakdown_internal", this ),14, 4 );
  grid->addWidget( pin_breakdown_internal_edit, 14, 5 );
  grid->addWidget( new QLabel( "aux1prod", this ),15, 4 );
  grid->addWidget( aux1prod_edit, 15, 5 );
  grid->addWidget( new QLabel( "aux1prodmeso", this ),16, 4 );
  grid->addWidget( aux1prodmeso_edit, 16, 5 );
  grid->addWidget( new QLabel( "aux1decay", this ),17, 4 );
  grid->addWidget( aux1decay_edit, 17, 5 );
  grid->addWidget( new QLabel( "aux1decaymeso", this ),18, 4 );
  grid->addWidget( aux1decaymeso_edit, 18, 5 );
  grid->addWidget( new QLabel( "aux1transport", this ),19, 4 );
  grid->addWidget( aux1transport_edit, 19, 5 );
  grid->addWidget( new QLabel( "aux_cons", this ),20, 4 );
  grid->addWidget( aux_cons_edit, 20, 5 );
  grid->addWidget( new QLabel( "aux_breakdown", this ),21, 4 );
  grid->addWidget( aux_breakdown_edit, 21, 5 );
  grid->addWidget( new QLabel( "kaux1", this ),22, 4 );
  grid->addWidget( kaux1_edit, 22, 5 );
  grid->addWidget( new QLabel( "kap", this ),23, 4 );
  grid->addWidget( kap_edit, 23, 5 );
  grid->addWidget( new QLabel( "leaf_tip_source", this ),24, 4 );
  grid->addWidget( leaf_tip_source_edit, 24, 5 );
  grid->addWidget( new QLabel( "sam_efflux", this ),3, 6 );
  grid->addWidget( sam_efflux_edit, 3, 7 );
  grid->setColumnMinimumWidth(7, 80);
  grid->addWidget( new QLabel( "sam_auxin", this ),4, 6 );
  grid->addWidget( sam_auxin_edit, 4, 7 );
  grid->addWidget( new QLabel( "sam_auxin_breakdown", this ),5, 6 );
  grid->addWidget( sam_auxin_breakdown_edit, 5, 7 );
  grid->addWidget( new QLabel( "van3prod", this ),6, 6 );
  grid->addWidget( van3prod_edit, 6, 7 );
  grid->addWidget( new QLabel( "van3autokat", this ),7, 6 );
  grid->addWidget( van3autokat_edit, 7, 7 );
  grid->addWidget( new QLabel( "van3sat", this ),8, 6 );
  grid->addWidget( van3sat_edit, 8, 7 );
  grid->addWidget( new QLabel( "k2van3", this ),9, 6 );
  grid->addWidget( k2van3_edit, 9, 7 );
  grid->addWidget( new QLabel( "", this), 10, 6, 1, 2 );
  grid->addWidget( new QLabel( " <b>Integration parameters</b>", this), 11, 6, 1, 2 );
  grid->addWidget( new QLabel( "dt", this ),12, 6 );
  grid->addWidget( dt_edit, 12, 7 );
  grid->addWidget( new QLabel( "rd_dt", this ),13, 6 );
  grid->addWidget( rd_dt_edit, 13, 7 );
  grid->addWidget( new QLabel( "movie", this ),14, 6 );
  grid->addWidget( movie_edit, 14, 7 );
  grid->addWidget( new QLabel( "nit", this ),15, 6 );
  grid->addWidget( nit_edit, 15, 7 );
  grid->addWidget( new QLabel( "maxt", this ),16, 6 );
  grid->addWidget( maxt_edit, 16, 7 );
  grid->addWidget( new QLabel( "rseed", this ),17, 6 );
  grid->addWidget( rseed_edit, 17, 7 );
  grid->addWidget( new QLabel( "", this), 18, 6, 1, 2 );
  grid->addWidget( new QLabel( " <b>Meinhardt leaf venation model</b>", this), 19, 6, 1, 2 );
  grid->addWidget( new QLabel( "constituous_expansion_limit", this ),20, 6 );
  grid->addWidget( constituous_expansion_limit_edit, 20, 7 );
  grid->addWidget( new QLabel( "vessel_inh_level", this ),21, 6 );
  grid->addWidget( vessel_inh_level_edit, 21, 7 );
  grid->addWidget( new QLabel( "vessel_expansion_rate", this ),22, 6 );
  grid->addWidget( vessel_expansion_rate_edit, 22, 7 );
  grid->addWidget( new QLabel( "d", this ),23, 6 );
  grid->addWidget( d_edit, 23, 7 );
  grid->addWidget( new QLabel( "e", this ),24, 6 );
  grid->addWidget( e_edit, 24, 7 );
  grid->addWidget( new QLabel( "f", this ),3, 8 );
  grid->addWidget( f_edit, 3, 9 );
  grid->setColumnMinimumWidth(9, 80);
  grid->addWidget( new QLabel( "c", this ),4, 8 );
  grid->addWidget( c_edit, 4, 9 );
  grid->addWidget( new QLabel( "mu", this ),5, 8 );
  grid->addWidget( mu_edit, 5, 9 );
  grid->addWidget( new QLabel( "nu", this ),6, 8 );
  grid->addWidget( nu_edit, 6, 9 );
  grid->addWidget( new QLabel( "rho0", this ),7, 8 );
  grid->addWidget( rho0_edit, 7, 9 );
  grid->addWidget( new QLabel( "rho1", this ),8, 8 );
  grid->addWidget( rho1_edit, 8, 9 );
  grid->addWidget( new QLabel( "c0", this ),9, 8 );
  grid->addWidget( c0_edit, 9, 9 );
  grid->addWidget( new QLabel( "gamma", this ),10, 8 );
  grid->addWidget( gamma_edit, 10, 9 );
  grid->addWidget( new QLabel( "eps", this ),11, 8 );
  grid->addWidget( eps_edit, 11, 9 );
  grid->addWidget( new QLabel( "", this), 12, 8, 1, 2 );
  grid->addWidget( new QLabel( " <b>User-defined parameters</b>", this), 13, 8, 1, 2 );
  grid->addWidget( new QLabel( "betaN", this ),14, 8 );
  grid->addWidget( betaN_edit, 14, 9 );
  grid->addWidget( new QLabel( "gammaN", this ),15, 8 );
  grid->addWidget( gammaN_edit, 15, 9 );
  grid->addWidget( new QLabel( "betaD", this ),16, 8 );
  grid->addWidget( betaD_edit, 16, 9 );
  grid->addWidget( new QLabel( "gammaD", this ),17, 8 );
  grid->addWidget( gammaD_edit, 17, 9 );
  grid->addWidget( new QLabel( "betaR", this ),18, 8 );
  grid->addWidget( betaR_edit, 18, 9 );
  grid->addWidget( new QLabel( "gammaR", this ),19, 8 );
  grid->addWidget( gammaR_edit, 19, 9 );
  grid->addWidget( new QLabel( "tau", this ),20, 8 );
  grid->addWidget( tau_edit, 20, 9 );
  grid->addWidget( new QLabel( "kt", this ),21, 8 );
  grid->addWidget( kt_edit, 21, 9 );
  grid->addWidget( new QLabel( "kc", this ),22, 8 );
  grid->addWidget( kc_edit, 22, 9 );
  grid->addWidget( new QLabel( "krs", this ),23, 8 );
  grid->addWidget( krs_edit, 23, 9 );
  grid->addWidget( new QLabel( "k", this ),24, 8 );
  grid->addWidget( k_edit, 24, 9 );
  grid->addWidget( new QLabel( "i1", this ),3, 10 );
  grid->addWidget( i1_edit, 3, 11 );
  grid->setColumnMinimumWidth(11, 80);
  grid->addWidget( new QLabel( "i2", this ),4, 10 );
  grid->addWidget( i2_edit, 4, 11 );
  grid->addWidget( new QLabel( "b4", this ),5, 10 );
  grid->addWidget( b4_edit, 5, 11 );
  grid->addWidget( new QLabel( "dir1", this ),6, 10 );
  grid->addWidget( dir1_edit, 6, 11 );
  grid->addWidget( new QLabel( "dir2", this ),7, 10 );
  grid->addWidget( dir2_edit, 7, 11 );
QPushButton *pb = new QPushButton( "&Write", this );
grid->addWidget(pb, 26, 8 );
connect( pb, SIGNAL( clicked() ), this, SLOT( write() ) );
QPushButton *pb2 = new QPushButton( "&Close", this );
grid->addWidget(pb2,26, 8+1 );
connect( pb2, SIGNAL( clicked() ), this, SLOT( close() ) );
QPushButton *pb3 = new QPushButton( "&Reset", this );
grid->addWidget(pb3, 26, 8+2 );
...
delete movie_edit;
delete nit_edit;
delete compatibility_level_edit;
delete maxt_edit;
delete rseed_edit;
...
QString tmpval;
  ...
  par.compatibility_level = compatibility_level_edit->text().toInt();
...
void ParameterDialog::Reset(void) {
  ...
  compatibility_level_edit->setText( QString("%1").arg(par.compatibility_level) );
