...
// add the first four widgets with (row, column) addressing
  ...
  grid->addWidget( new QLabel( "kc", this ),21, 6 );
  grid->addWidget( kc_edit, 21, 7 );
  grid->addWidget( new QLabel( "krs", this ),22, 6 );
  grid->addWidget( krs_edit, 22, 7 );
  grid->addWidget( new QLabel( "betaN", this ),23, 6 );
  grid->addWidget( betaN_edit, 23, 7 );
  grid->addWidget( new QLabel( "betaD", this ),24, 6 );
  grid->addWidget( betaD_edit, 24, 7 );
  grid->addWidget( new QLabel( "betaR", this ),25, 6 );
  grid->addWidget( betaR_edit, 25, 7 );
  grid->addWidget( new QLabel( "i1", this ),26, 6 );
  grid->addWidget( i1_edit, 26, 7 );
  grid->addWidget( new QLabel( "i2", this ),27, 6 );
  grid->addWidget( i2_edit, 27, 7 );
