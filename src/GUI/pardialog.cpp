...
// add the first four widgets with (row, column) addressing
  ...
  grid->addWidget( new QLabel( "i1", this ),24, 8 );
  grid->addWidget( i1_edit, 24, 9 );
  grid->addWidget( new QLabel( "i2", this ),3, 10 );
  grid->addWidget( i2_edit, 3, 11 );
  grid->setColumnMinimumWidth(11, 80);
  grid->addWidget( new QLabel( "b4", this ),4, 10 );
  grid->addWidget( b4_edit, 4, 11 );
  grid->addWidget( new QLabel( "dir1", this ),5, 10 );
  grid->addWidget( dir1_edit, 5, 11 );
  grid->addWidget( new QLabel( "dir2", this ),6, 10 );
  grid->addWidget( dir2_edit, 6, 11 );
