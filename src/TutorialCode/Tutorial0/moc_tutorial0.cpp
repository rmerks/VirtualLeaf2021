...
struct qt_meta_stringdata_Tutorial0_t {
    QByteArrayData data[1];
    char stringdata0[10];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_Tutorial0_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_Tutorial0_t qt_meta_stringdata_Tutorial0 = {
    {
QT_MOC_LITERAL(0, 0, 9) // "Tutorial0"
...
QT_INIT_METAOBJECT const QMetaObject Tutorial0::staticMetaObject = { {
    &QObject::staticMetaObject,
    qt_meta_stringdata_Tutorial0.data,
    qt_meta_data_Tutorial0,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *Tutorial0::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_Tutorial0.stringdata0))
...
QT_MOC_EXPORT_PLUGIN(Tutorial0, Tutorial0)
