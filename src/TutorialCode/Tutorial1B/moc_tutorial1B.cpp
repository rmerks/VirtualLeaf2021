...
struct qt_meta_stringdata_Tutorial1B_t {
    QByteArrayData data[1];
    char stringdata0[11];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_Tutorial1B_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_Tutorial1B_t qt_meta_stringdata_Tutorial1B = {
    {
QT_MOC_LITERAL(0, 0, 10) // "Tutorial1B"
...
QT_INIT_METAOBJECT const QMetaObject Tutorial1B::staticMetaObject = { {
    &QObject::staticMetaObject,
    qt_meta_stringdata_Tutorial1B.data,
    qt_meta_data_Tutorial1B,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *Tutorial1B::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_Tutorial1B.stringdata0))
...
QT_MOC_EXPORT_PLUGIN(Tutorial1B, Tutorial1B)
