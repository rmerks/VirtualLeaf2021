...
ParameterDialog::ParameterDialog(QWidget *parent, Qt::WindowFlags f) : QDialog(parent,f) {
  ...
  i3_edit = new QLineEdit( QString("%1").arg(par.i3), this );
  i4_edit = new QLineEdit( QString("%1").arg(par.i4), this );
  i5_edit = new QLineEdit( QString("%1").arg(par.i5), this );
  s1_edit = new QLineEdit( QString("%1").arg(par.s1), this );
  s2_edit = new QLineEdit( QString("%1").arg(par.s2), this );
  s3_edit = new QLineEdit( QString("%1").arg(par.s3), this );
  b1_edit = new QLineEdit( QString("%1").arg(sbool(par.b1)), this );
  b2_edit = new QLineEdit( QString("%1").arg(sbool(par.b2)), this );
  b3_edit = new QLineEdit( QString("%1").arg(sbool(par.b3)), this );
...
QString tmpval;
  ...
  par.s1 = strdup(s1_edit->text().toLatin1());
  par.s2 = strdup(s2_edit->text().toLatin1());
  par.s3 = strdup(s3_edit->text().toLatin1());
  tmpval = b1_edit->text().trimmed();
