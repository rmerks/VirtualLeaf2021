...
struct qt_meta_stringdata_AuxinGrowthPlugin_t {
    QByteArrayData data[1];
    char stringdata0[18];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_AuxinGrowthPlugin_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_AuxinGrowthPlugin_t qt_meta_stringdata_AuxinGrowthPlugin = {
    {
QT_MOC_LITERAL(0, 0, 17) // "AuxinGrowthPlugin"
...
QT_INIT_METAOBJECT const QMetaObject AuxinGrowthPlugin::staticMetaObject = { {
    &QObject::staticMetaObject,
    qt_meta_stringdata_AuxinGrowthPlugin.data,
    qt_meta_data_AuxinGrowthPlugin,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *AuxinGrowthPlugin::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_AuxinGrowthPlugin.stringdata0))
...
static constexpr unsigned char qt_pluginMetaData[] = {
    ...
    0xbf, 
    // "IID"
    0x02,  0x78,  0x21,  'o',  'r',  'g',  '.',  'v', 
    'i',  'r',  't',  'u',  'a',  'l',  'l',  'e', 
    'a',  'f',  '.',  'a',  'u',  'x',  'i',  'n', 
    'g',  'r',  'o',  'w',  't',  'h',  'p',  'l', 
    'u',  'g',  'i',  'n', 
    // "className"
    0x03,  0x71,  'A',  'u',  'x',  'i',  'n',  'G', 
    'r',  'o',  'w',  't',  'h',  'P',  'l',  'u', 
    'g',  'i',  'n', 
    0xff, 
};
QT_MOC_EXPORT_PLUGIN(AuxinGrowthPlugin, AuxinGrowthPlugin)
