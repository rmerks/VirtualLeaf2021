...
// add the first four widgets with (row, column) addressing
  ...
  grid->addWidget( new QLabel( "kt", this ),25, 6 );
  grid->addWidget( kt_edit, 25, 7 );
  grid->addWidget( new QLabel( "kc", this ),26, 6 );
  grid->addWidget( kc_edit, 26, 7 );
  grid->addWidget( new QLabel( "krs", this ),27, 6 );
  grid->addWidget( krs_edit, 27, 7 );
  grid->addWidget( new QLabel( "b4", this ),28, 6 );
  grid->addWidget( b4_edit, 28, 7 );
  grid->addWidget( new QLabel( "dir1", this ),29, 6 );
  grid->addWidget( dir1_edit, 29, 7 );
  grid->addWidget( new QLabel( "dir2", this ),3, 8 );
  grid->addWidget( dir2_edit, 3, 9 );
