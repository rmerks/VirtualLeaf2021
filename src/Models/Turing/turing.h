/*
 *  $Id: meinhardtplugin.h,v 6bcb69712a0e 2010/11/24 17:02:13 roeland $
 *
...
#ifndef _TURINGPLUGIN_H_
#define _TURINGPLUGIN_H_
...
class TuringPlugin : public QObject, SimPluginInterface {
  Q_OBJECT
    Q_INTERFACES(SimPluginInterface);
    Q_PLUGIN_METADATA(IID "org.virtualleaf.turingplugin")
 public:
  virtual QString ModelID(void) { return QString( "Turing Pattern" ); }
  ...
  virtual int NChem(void) { return 3; }

  // default XML file to be loaded on startup
  virtual QString DefaultLeafML(void) { return QString("grid.xml"); }
};
