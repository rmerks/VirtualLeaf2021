...
class CellOutlines : public QObject, SimPluginInterface {
	Q_OBJECT
	Q_INTERFACES(SimPluginInterface);
        Q_PLUGIN_METADATA(IID "org.virtualleaf.CellOutlines")
...
public:
    ...
    virtual QString DefaultLeafML(void) { return QString("smalltissue.xml"); }
};
