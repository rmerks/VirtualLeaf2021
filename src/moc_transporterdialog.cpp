...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_TransporterDialog_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_TransporterDialog_t qt_meta_stringdata_TransporterDialog = {
    {
QT_MOC_LITERAL(0, 0, 17), // "TransporterDialog"
QT_MOC_LITERAL(1, 18, 20), // "setTransporterValues"
...
QT_INIT_METAOBJECT const QMetaObject TransporterDialog::staticMetaObject = { {
    ...
    qt_meta_stringdata_TransporterDialog.data,
