...
class MyAuxinModel : public QObject, SimPluginInterface {
	Q_OBJECT
...
public:
	...
	// Implement the PIN1 recycling equations
	virtual double PINflux(CellBase *this_cell, CellBase *adjacent_cell, Wall *w); 

	// Name the default leaf file
	virtual QString DefaultLeafML (void){return QString("myAuxin.xml");}
};
